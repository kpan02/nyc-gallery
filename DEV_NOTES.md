...
- `generate-metadata` is recursive; `generate-thumbnails` is currently not.
- Slug generation can collide for files sharing the same base name.
- `delete-photo` currently does not auto-remove slug from favorites list.